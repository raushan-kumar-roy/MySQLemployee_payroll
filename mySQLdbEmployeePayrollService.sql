...
#UC7
insert into payroll_service.employee_payroll (name, gender, salary, start) values ( 'Sarvesh','M',650000.00,'2018-04-02'),
('Riya','F',250000.00,'2019-10-12'), ('Naveen','M',120000.00,'2019-11-08'), ( 'Jack','M',500000.00,'2020-11-05');
...
insert into Employee (Emp_Name, Gender, DOJ, Department, Salary) values ("Iconic", "Male", '2020-11-21', "IT", 1900000), 
("Punk", "Male", '2020-04-12', "IT", 2500000), ("Priyanka", "Female", '2020-08-21', "Marketing", 1500000),
("Hemangi", "Female", '2020-01-20', "Marketing", 1750000);
...
select * from employee;
select * from employee_department;
select salary from employee where name='sahil';
